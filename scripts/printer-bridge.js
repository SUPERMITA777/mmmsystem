...
function buildPrintScript(printerName, htmlFilePath) {
    ...
    ps += '    $allPrinters = Get-CimInstance -ClassName Win32_Printer\r\n';
    ps += '    $matched = $null\r\n';
    ps += '    foreach ($p in $allPrinters) {\r\n';
    ps += '        if ($p.Name -eq $printerName) {\r\n';
    ps += '            $matched = $p\r\n';
    ps += '            break\r\n';
    ps += '        }\r\n';
    ps += '    }\r\n';
    ...
    ps += '        foreach ($p in $allPrinters) {\r\n';
    ps += '            $pLocalLower = $p.Name.ToLower()\r\n';
    ps += '            if ($pLocalLower.Contains($pNameLower) -or $pNameLower.Contains($pLocalLower)) {\r\n';
    ps += '                $matched = $p\r\n';
    ps += '                break\r\n';
    ps += '            }\r\n';
    ps += '        }\r\n';
    ps += '    }\r\n';
    ps += '    if (-not $matched) {\r\n';
    ps += '        $matched = Get-CimInstance -ClassName Win32_Printer -Filter "Default=True"\r\n';
    ps += '    }\r\n';
    ps += '    $currentDefault = (Get-CimInstance -ClassName Win32_Printer -Filter "Default=True").Name\r\n';
    ps += '    if ($matched) {\r\n';
    ps += '        Invoke-CimMethod -InputObject $matched -MethodName SetDefaultPrinter | Out-Null\r\n';
    ps += '    }\r\n';
