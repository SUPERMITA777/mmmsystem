...
function buildPrintScript(printerName, htmlFilePath) {
    ...
    ps += '    if (-not $printer) {\r\n';
    ps += '        Write-Host "ERROR: No se encontro la impresora: $printerName"\r\n';
    ps += '        exit 1\r\n';
    ps += '    }\r\n';
    ps += '    Write-Host "Paso 2: Guardando impresora predeterminada..."\r\n';
    ps += '    $currentDefault = (Get-CimInstance -ClassName Win32_Printer -Filter "Default=True").Name\r\n';
    ps += '    Write-Host "Paso 3: Estableciendo impresora destino..."\r\n';
    ps += '    Invoke-CimMethod -InputObject $printer -MethodName SetDefaultPrinter | Out-Null\r\n';
    ps += '    Write-Host "Paso 4: Creando motor de renderizado..."\r\n';
    ...
    ps += '    Write-Host "Paso 5: Navegando al documento..."\r\n';
    ps += '    $browser.Navigate($htmlFile)\r\n';
    ps += '    $timeout = 0\r\n';
    ps += '    while ($browser.ReadyState -ne "Complete" -and $timeout -lt 100) {\r\n';
    ...
    ps += '    }\r\n';
    ps += '    Write-Host "Impresion completada exitosamente."\r\n';
    ps += '} catch {\r\n';
    ps += '    Write-Host ("ERROR EN POWERSHELL: " + $_.Exception.Message)\r\n';
    ps += '    exit 1\r\n';
    ps += '}\r\n';
    return ps;
}
