    ...
    <section className="p-6 max-w-5xl">
      ...
      {activeTab === "mundial" && (
        <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
          ...
          <p className="text-gray-600 mb-6">La plataforma de predicciones está integrada en tu sistema. Haz clic en los siguientes botones para acceder.</p>
          <div className="flex flex-col sm:flex-row gap-4">
            <a href={`/${tenant}/admin/mundial`} className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-xl shadow-md transition-colors text-center">
              Panel de Administración
            </a>
            <a href={`/${tenant}/mundial`} target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-gray-900 text-white font-bold py-3 px-6 rounded-xl shadow-md transition-colors text-center">
              Ver Web Pública
            </a>
          </div>
        </div>
